#[cfg(feature = "pdf_comparison_tests")]
mod tests {
    use rckive_genpdf::{elements, fonts, style, Element as _};
    ...
    /// modification dates.
    fn get_document() -> rckive_genpdf::Document {
    ...
    fn check(name: &str, doc: rckive_genpdf::Document) {
        ...
        if expected_path.exists() {
            let expected_doc =
                std::fs::read(&expected_path).expect("Failed to read expected document");
    ...
    test_with_document! {
        #[test]
        fn minimal(doc: rckive_genpdf::Document) -> rckive_genpdf::Document {
            doc
        }

        #[test]
        fn text(doc: rckive_genpdf::Document) -> rckive_genpdf::Document {
            // TODO: Why 14pt and not 12?
            let mut doc = doc;
            doc.set_paper_size((12, rckive_genpdf::Mm::from(printpdf::Pt(14.0))));
        ...
        #[ignore]
        fn paragraph_long(doc: rckive_genpdf::Document) -> rckive_genpdf::Document {
            let mut doc = doc;
        ...
        #[test]
        fn kerning(doc: rckive_genpdf::Document) -> rckive_genpdf::Document {
            let mut doc = doc;
        ...
        #[test]
        #[ignore]
        fn sizes(doc: rckive_genpdf::Document) -> rckive_genpdf::Document {
        ...
        #[test]
        fn frame_single(doc: rckive_genpdf::Document) -> rckive_genpdf::Document {
            let mut doc = doc;
        ...
        #[test]
        fn frame_multi(doc: rckive_genpdf::Document) -> rckive_genpdf::Document {
            let mut doc = doc;
            doc.set_paper_size((100, 30));
        ...
        #[test]
        fn frame_single_thick(doc: rckive_genpdf::Document) -> rckive_genpdf::Document {
            let mut doc = doc;
            doc.set_paper_size((100, 30));
        ...
        #[test]
        fn frame_multi_thick(doc: rckive_genpdf::Document) -> rckive_genpdf::Document {
            let mut doc = doc;
            doc.set_paper_size((100, 30));
